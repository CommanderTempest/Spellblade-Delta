...
public partial class NPCEntity : CharacterEntity
{
	enum Factions {
	...
	[Export] private Factions faction;

	// A lot of the below GDScript class needs to be converted to using states instead (enemyStates)
}
